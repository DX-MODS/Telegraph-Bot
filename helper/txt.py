...
•> /start a bot and send any picture to automatically upload to bot.
•> /this bot support media type only.
•> /supporting media type mp4,img,jpg,gif etc.
•> / only support 5 mb files
"""
